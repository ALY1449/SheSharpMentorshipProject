...
mentee_database = pd.read_csv(
    '/Users/alyssapausanos/SheSharpMentorshipProject/SheSharpMentorshipProject/dev/src/app/backend/api/backend/tests/dummy-data-test/mentee_eoi_data2.csv')
mentor_database = pd.read_csv(
    '/Users/alyssapausanos/SheSharpMentorshipProject/SheSharpMentorshipProject/dev/src/app/backend/api/backend/tests/dummy-data-test/mentor_eoi_data2.csv')
...
model = keras.models.load_model(
    "/Users/alyssapausanos/SheSharpMentorshipProject/SheSharpMentorshipProject/dev/src/app/backend/api/backend/src/mentor_recommendation_model_with_personalities_v2.1.h5")
...
print(top_3_df)
top_3_df.to_csv(
    '/Users/alyssapausanos/SheSharpMentorshipProject/SheSharpMentorshipProject/dev/src/app/backend/api/backend/tests/dummy-data-test/proposed_matches.csv', index=False)
